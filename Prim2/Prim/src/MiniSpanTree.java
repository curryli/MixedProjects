...
//                  System.out.println("MINV="+minV+"||tree[minV][j]="+tree[minV][j]);  
    ...
    public static void main(String [] args){  
        ...
        int [] V={1,2,3,4,5,6};  
        Edge [] E=new Edge[10];  
        E[0]=new Edge(1L,2L,6.0);  
        E[1]=new Edge(1L,3L,1.0);  
        E[2]=new Edge(1L,4L,5.0);  
        E[3]=new Edge(2L,3L,5.0);  
        E[4]=new Edge(2L,5L,3.0);  
        E[5]=new Edge(3L,4L,5.0);  
        E[6]=new Edge(3L,5L,6.0);  
        E[7]=new Edge(3L,6L,4.0);  
        E[8]=new Edge(4L,6L,2.0);  
        E[9]=new Edge(5L,6L,6.0);  
